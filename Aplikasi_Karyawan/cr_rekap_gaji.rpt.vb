...
Public Class cr_rekap_gajirpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Karyawan.cr_rekap_gaji.rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_rekap_gajirpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_rekap_gajirpt = New cr_rekap_gajirpt
        rpt.Site = Me.Site
        Return rpt
    End Function
