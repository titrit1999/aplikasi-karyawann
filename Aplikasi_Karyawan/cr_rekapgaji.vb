...
Public Class cr_rekapgaji
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Karyawan.cr_rekapgaji.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_rekapgaji
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_rekapgaji = New cr_rekapgaji
        rpt.Site = Me.Site
        Return rpt
    End Function
